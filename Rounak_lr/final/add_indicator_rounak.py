...
def get_data(timeframe, name):
    return read_file("C:/Users/interiit/ZeltaLabPS/data/" + name  + "/btcusdt_" + timeframe + "_" + name + ".csv")


# Load data
df_train = get_data(time_frame, "train")
df_test = get_data(time_frame, "test")
...
df.to_csv("data_with_new_indicators/btcusdt_" +time_frame +"_complete_"+".csv")
